¡Tenemos nuestro primer paquete para entregar! Pero no estamos seguros de si hay que llevarlo a `laMatrix` o al `puenteDeBrooklin`, que deja pasar a todo lo que pese hasta 1000 kilos.
